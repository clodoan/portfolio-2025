...
export default async function Home() {
  ...
  return (
    <div className="w-screen flex flex-col text-primary min-h-screen">
      <div className="flex flex-col gap-4 max-w-container-mobile md:max-w-container-desktop mx-auto py-24 rounded overflow-hidden motion-opacity-in-0 motion-blur-in-md motion-duration-1500 z-0">
